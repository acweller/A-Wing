...
CREATE TABLE `esquadrao` (
  `cod_esquadrao` int(11) NOT NULL COMMENT 'CÃ³digo auto-incrementado para os esquadÃµes StarWars',
  `nom_esquadrao` varchar(30) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Armazena o nome dos esquadrÃµes apresentadas no Star Wars',
  `descricao` varchar(3000) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'DescriÃ§Ã£o dos esquadrÃµes',
  `datahora` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Data e Hora da Ãºltima modificaÃ§Ã£o'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='EsquadrÃµes conhecidos no universo Star Wars';
...
CREATE TABLE `membro_esquadrao` (
  ...
  `descricao` varchar(3000) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Descrição sobre o personagem neste esquadrÃ£o',
  `datahora` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Data e Hora da ultima modificação'
...
CREATE TABLE `personagem` (
  `cod_personagem` int(11) NOT NULL COMMENT 'CÃ³digo do personagem',
  ...
  `descricao` varchar(3000) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'DescriÃ§Ã£o sobre o personagem',
  `datahora` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Data e Hora da Ãºltima modificaÃ§Ã£o'
...
CREATE TABLE `starship` (
  ...
  `datahora` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Data e Hora de ultima atualizaÃ§Ã£o'
...
CREATE TABLE `starship_type` (
  `cod_type` int(11) NOT NULL COMMENT 'CÃ³digo auto-incrementado para o tipo de naves',
...
--
-- Ãndices de tabela `esquadrao`
--
ALTER TABLE `esquadrao`
  ADD PRIMARY KEY (`cod_esquadrao`);

--
-- Ãndices de tabela `membro_esquadrao`
--
...
--
-- Ãndices de tabela `personagem`
--
ALTER TABLE `personagem`
  ADD PRIMARY KEY (`cod_personagem`);

--
-- Ãndices de tabela `starship`
--
...
--
-- Ãndices de tabela `starship_pilot`
--
...
--
-- Ãndices de tabela `starship_type`
--
...
--
ALTER TABLE `esquadrao`
  MODIFY `cod_esquadrao` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Codigo auto-incrementado para os esquadrões StarWars';
--
...
--
-- RestriÃ§Ãµes para tabelas `membro_esquadrao`
--
ALTER TABLE `membro_esquadrao`
